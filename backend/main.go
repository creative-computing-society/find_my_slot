...
func main() {
	...
	authorized_user := router.Group("/", login.AuthMiddleware)
	{
		...
		authorized_user.GET("/myQuizSlot", tollbooth_gin.LimitHandler(limiter), quiz.FindMyQuizSlot)
		authorized_user.GET("/myPISlot", tollbooth_gin.LimitHandler(limiter), quiz.FindMyPISlot)
		authorized_user.GET("/latestAnnouncement", tollbooth_gin.LimitHandler(limiter), quiz.Announcement)
		authorized_user.GET("/myFinalResult", tollbooth_gin.LimitHandler(limiter), quiz.FinalResult)
	}
